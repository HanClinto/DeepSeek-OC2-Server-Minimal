...
<table>
  ...
  <tr><td><code>POST</code></td><td><code>/ocr</code></td><td>Run OCR on an uploaded image; returns <code>{"result": "..."}</code></td></tr>
...
<table>
  ...
  <tr><td><code>file</code></td><td>file</td><td>✅</td><td>–</td><td>Image to process (PNG, JPG, TIFF, PDF, …)</td></tr>
...
<div id="drop-zone">
  <p>📁 Drag &amp; drop an image here, or <strong>click to select</strong></p>
</div>
